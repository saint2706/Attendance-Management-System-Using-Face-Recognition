...
def test_extract_all_embeddings_list_of_lists() -> None:
    ...
    # If the item is a list (e.g., [0.1, 0.2]), extract_embedding sees it as list of length 2  # noqa: E501
    # but the logic there expects representations as either a list of dicts or list of lists.
    # Passing [[[0.1, 0.2]], [[0.3, 0.4]]] allows extract_embedding to parse each internal list properly.  # noqa: E501
...
def test_find_closest_match_faiss_invalid_index() -> None:
    ...
    assert pipeline.find_closest_match_faiss(probe, "not_faiss_index") is None  # type: ignore[arg-type]  # noqa: E501
