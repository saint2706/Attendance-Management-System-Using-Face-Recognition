...
class TestAttendanceViewSetMarkEndpoint:
    ...
    def api_client(self):
        ...
        # though the main issue is rate-limiting based on IP/User. Let's patch get_rate for the test.  # noqa: E501
        return APIClient()
    ...
    def test_mark_match_below_threshold(self, api_client, admin_user, monkeypatch):
        ...
        # Force pipeline.find_closest_dataset_match to return a match with high distance (low confidence)  # noqa: E501
        monkeypatch.setattr(
            pipeline,
