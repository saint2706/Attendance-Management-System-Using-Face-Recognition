            ...
            <section className="stats-section" aria-labelledby="stats-title">
                ...
                {hasError ? (
                    <div className="text-center py-12 w-full card card-elevated" style={{ gridColumn: '1 / -1' }} role="alert" aria-live="assertive">
                        ...
                        <button onClick={() => fetchStats()} className="btn btn-secondary" title="Retry loading statistics" aria-label="Retry loading statistics" disabled={isLoadingStats} aria-busy={isLoadingStats}>
                            {isLoadingStats ? (
