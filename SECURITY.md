...
<!-- This file is a stub that points to the detailed security documentation -->

# Security Policy

For detailed security configuration, hardening guides, and operational checklists, please refer to the [Security & Compliance Guide](docs/security.md).
