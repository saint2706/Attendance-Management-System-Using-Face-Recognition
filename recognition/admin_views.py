...
def failure_analysis(request: HttpRequest) -> HttpResponse:
    ...
    if failure_cases_csv.exists():
        ...
        context["false_accepts"] = list(fa_df.to_dict("records")) if not bool(fa_df.empty) else []  # type: ignore[assignment]  # noqa: E501
        context["false_rejects"] = list(fr_df.to_dict("records")) if not bool(fr_df.empty) else []  # type: ignore[assignment]  # noqa: E501
