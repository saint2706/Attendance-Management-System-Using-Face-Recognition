...
- Removed redundant `aria-label="Start Setup Wizard"` from the "Setup Wizard" button in `frontend/src/pages/Dashboard.tsx` since it already has visible text, satisfying WCAG 2.5.3 'Label in Name'.
